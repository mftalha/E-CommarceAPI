...
{
    public class CustomerReadRepository : ReadRepository<Customer>, ICustomerReadRepository // ReadRepository<Customer> , == şeklinde virgülden önce boşluk verdiğimde hata veriyor. 
    ...
    {
        public CustomerReadRepository(ETicaretAPIDbContext context) : base(context) // ReadRepository constracterında bizden  tane paremetre istiyordu = context == bu yüzden CustomerReadRepository'ın constracterından talep edip vermem gerekiyor bunu = yoksa hata verir zaten.
